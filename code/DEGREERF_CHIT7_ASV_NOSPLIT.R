...
# importance.df <- read.table("DEGREERFEVarImp_Class-log.mN7.norm_ASV_AllRepTrain.tsv", header = TRUE, sep = "\t")
...
pdf("DEGREEPlot_RFEMultiwayImp_CHIT_ASV.pdf", width = 7, height = 6)
print(p)
