...
asv_mse_data <- read.table("../data/varMSEINCR_Class-log.XYLO7.norm_ASV_AllRepTrain.tsv", sep="")
cluster_mse_data <- read.table("../data/varMSEINCR_Class-log.XYLO7.norm_Cluster_AllRepTrain.tsv", sep="")
