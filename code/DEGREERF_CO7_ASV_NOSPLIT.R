...
# importance.df <- read.table("DEGREERFEVarImp_Class-log.mCO2.7.norm_ASV_AllRepTrain.tsv", header = TRUE, sep = "\t")
...
pdf("DEGREEPlot_RFEMultiwayImp_CO_ASV.pdf", width = 7, height = 6)
print(p)
