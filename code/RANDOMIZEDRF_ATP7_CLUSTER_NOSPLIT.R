...
shuffled_clusters <- sample(cluster_data$functionInk) # Randomizing order of clusters
shuffled_ASVs <- sample(cluster_data$ASV) # Randomizing order of ASVs
cluster_data <- data.frame(ASV = shuffled_ASVs, functionInk = shuffled_clusters) # Replacing cluster data with randomized version
...
# Name of output file
fileOut=paste("RANDOMRF_Class-",select.class,select.cond,
...
fileOut=paste("RandomRFEVarImp_Class-",select.class,select.cond,
              "_",predictor.unit,"_",replicate.train,
...
plotOut=paste("RandomPlot_RFEMultiwayImp_Class-",select.class,select.cond,
              "_",predictor.unit,"_",replicate.train,
...
## Error plot
plotOut=paste("RandomPlot_Error_Class-",select.class,select.cond,
              "_",predictor.unit,"_",replicate.train,
...
fileOut=paste("RandomvarMSEINCR_Class-",select.class,select.cond,
              "_",predictor.unit,"_",replicate.train,
              ".tsv",sep="") # Name of file
...
fileOut=paste("RandomvarNODEPURINCR_Class-",select.class,select.cond,
              "_",predictor.unit,"_",replicate.train,
              ".tsv",sep="") # Name of file
