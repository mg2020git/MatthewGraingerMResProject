...
file.cluster = "max_tot_ext_network_table.tsv"
...
dirCluster=paste(this.dir,"/data/",sep="") # Directory of cluster data
...
# Loop to generate list of different numbers of trees to test
...
write.table(importance.df,file=fileOut,sep = "\t",quote=FALSE) # Write to file
# Most important variables
ASV.top = important_variables(importance.df) # Most important variables (DOESN'T GIVE IMPORTANCE METRICS, JUST VARIABLES)
fileOut=paste("varTop_Class-",select.class,select.cond,
              "_ntree",trunc(ntree.in),"_mtry",trunc(mtry.in),
              "_",predictor.unit,"_",replicate.train,
              ".tsv",sep="") # Name of file
write.table(ASV.top,file=fileOut,sep = "\t",quote=FALSE) # Write to file
## Variable importance again, this time using Caret function
fileOut=paste("varImp_Class-",select.class,select.cond,
              "_ntree",trunc(ntree.in),"_mtry",trunc(mtry.in),
              "_",predictor.unit,"_",replicate.train,
              ".tsv",sep="") # Name of file
...
fileOut=paste("varTopMSEINCR_Class-",select.class,select.cond,
              ...
              "_",predictor.unit,"_",replicate.train,
              ".tsv",sep="") # Name of file
write.table(sorted_importance_df_mse,file=fileOut,sep = "\t",quote=FALSE) # Write to file
...
fileOut=paste("varTopNODEPURINCR_Class-",select.class,select.cond,
              ...
              "_",predictor.unit,"_",replicate.train,
              ".tsv",sep="") # Name of file
write.table(sorted_importance_df_nodepurity,file=fileOut,sep = "\t",quote=FALSE) # Write to file
...
plotOut=paste("Plot_accuracyVsGini_Class-",select.class,select.cond,
              "_ntree",trunc(ntree.in),"_mtry",trunc(mtry.in),
              "_",predictor.unit,"_",replicate.train,
